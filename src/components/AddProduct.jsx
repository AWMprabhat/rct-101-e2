...
import { Modal, ModalOverlay, ModalContent, ModalHeader,
  ModalBody, ModalCloseButton,  Button, useDisclosure, FormControl, FormLabel,Input, Select,RadioGroup,Radio, Stack,InputGroup,InputLeftElement,Flex,
...
const AddProduct = ({ add }) => {
  ...
  const handleOnSubmit = (e) => {
    e.preventDefault();
    add({ ...form, imageSrc: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8mEIWZjRFdiO4YIkq790lTaNzTtCH6DcwrQ&usqp=CAU" });
    onClose();
  };
